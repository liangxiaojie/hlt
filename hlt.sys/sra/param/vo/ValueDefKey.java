...
public class ValueDefKey extends AbstractPrimaryKey {

  private static String table = "T_SYS_VALUE_DEF";
  private static String pk = "VALUE_CD";
  private static String format = "0000000000";
  private static int offset = 0;

  private static ValueDefKey instance = null;

  public static ValueDefKey getInstance() {
    if (instance == null) {
      instance = new ValueDefKey();
